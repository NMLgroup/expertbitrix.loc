...
<body id="home">
    ...
    <div class="intro-header">
		<div class="col-xs-12 text-center abcen1">
			<h1 class="h1_home wow fadeIn" data-wow-delay="0.4s">EXPERTBITRIX</h1>
			<h3 class="h3_home wow fadeIn" data-wow-delay="0.7s">КОМАНДА -> РЕШЕНИЕ -> УСПЕХ</h3>
			<!--<h3 class="h3_home wow fadeIn" data-wow-delay="1.1s"></h3>
			<h3 class="h3_home wow fadeIn" data-wow-delay="1.4s"></h3> -->
			<ul class="list-inline intro-social-buttons">
				<li><a href="https://twitter.com/galantiandrea" class="btn  btn-lg mybutton_cyano wow fadeIn" data-wow-delay="1.1s"><span class="network-name">Bitr</span></a>
				</li>
				<li id="download" ><a href="#downloadlink" class="btn  btn-lg mybutton_standard wow swing wow fadeIn" data-wow-delay="1.4s"><span class="network-name">Free Download</span></a>
				</li>
			</ul>
		</div>    
        <!-- /.container -->
	...
	<nav class="navbar-default" role="navigation">
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#home">ExpertBitrix</a>
			</div>

			<div class="collapse navbar-collapse navbar-right navbar-ex1-collapse">
				<ul class="nav navbar-nav">
					
					<li class="menuItem"><a href="#whatis">Возможности BITRIX24</a></li>
					<li class="menuItem"><a href="#useit">Use It</a></li>
					<li class="menuItem"><a href="#screen">Цены</a></li>
					<li class="menuItem"><a href="#credits">Credits</a></li>
					<li class="menuItem"><a href="#contact">Обратная связь</a></li>
				</ul>
			</div>
	...
	<div id="whatis" class="content-section-b" style="border-top: 0">
		<div class="container">
			...
			<div class="col-md-6 col-md-offset-3 text-center wrap_title">
				<h2>Возможности BITRIX24</h2>
				<p class="lead" style="margin-top:0">Создавая вместе лучшее!</p>
			</div>
			<div class="row">
	...
	<div id="screen" class="content-section-b">
	        <div class="container">
				<?php include 'views/price/index.html'; ?>
			</div>
        </div>
	</div>
	...
	<div id="contact" class="content-section-a">
		<div class="container">
			...
			<div class="col-md-6 col-md-offset-3 text-center wrap_title">
				...
				<p class="lead" style="margin-top:0">Рады предложить взаимовыгодное сотрудничество</p>
			</div>
			...
			<form role="form" action="" method="post" >
				<div class="col-md-6">
					...
					<input type="submit" name="submit" id="submit" value="Отправить" class="btn wow tada btn-embossed btn-primary pull-right">
				</div>
			</form>
